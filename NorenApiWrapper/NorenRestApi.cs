...
namespace NorenRestApiWrapper
{
    ...
    public class NorenRestApi
    {
        ...
        #region redundant
        private bool Changepwd(OnResponse response, Changepwd changepwd)
        {
            if (loginResp == null)
                return false;
        ...
        private bool SendProductConversion(OnResponse response, ProductConversion productConversion)
        {
            if (loginResp == null)
                return false;
        ...
        private bool SendForgotPassword(OnResponse response, string endpoint, string user, string pan, string dob)
        {            
        ...
        private bool SendGetUserDetails(OnResponse response)
        {
            if (loginResp == null)
                return false;
        ...
        private bool SendGetMWList(OnResponse response)
        {
            if (loginResp == null)
                return false;
        ...
        private bool SendSearchScrip(OnResponse response, string exch, string searchtxt)
        {
            if (loginResp == null)
                return false;
        ...
        private bool SendAddMultiScripsToMW(OnResponse response, string watchlist, string scrips)
        {
            if (loginResp == null)
                return false;
        ...
        private bool SendDeleteMultiMWScrips(OnResponse response, string watchlist, string scrips)
        {
            if (loginResp == null)
                return false;
        ...
        private bool SendGetMultiLegOrderBook(OnResponse response, string product)
        {
            if (loginResp == null)
                return false;
        ...
        public bool SendGetTradeBook(OnResponse response)
        {
            if (loginResp == null)
                return false;
        ...
        private bool SendGetOrderHistory(OnResponse response, string norenordno)
        {
            if (loginResp == null)
                return false;
        ...
        public bool SendGetPositionBook(OnResponse response)
        {
            ...
            string uri = "InteropPositionBook";
        ...
        private bool SendGetOrderMargin(OnResponse response, OrderMargin order)
        {
            if (loginResp == null)
                return false;
        ...
        private bool SendGetBasketMargin(OnResponse response, BasketMargin basket)
        {
            if (loginResp == null)
                return false;
        ...
        #endregion
        #region others
        private bool SendGetExchMsg(OnResponse response, ExchMsg exchmsg)
        {
            if (loginResp == null)
                return false;
        ...
        #endregion
        #region feed methods
        private bool SendGetQuote(OnResponse response, string exch, string token)
        {
            if (loginResp == null)
                return false;
        ...
        private bool SendGetTPSeries(OnResponse response, string exch, string token, string starttime = null, string endtime = null, string interval = null)
        {
            if (loginResp == null)
                return false;
            string uri = "TPSeries";
        ...
        private bool SendGetIndexList(OnResponse response, string exch)
        {
            if (loginResp == null)
                return false;
        ...
        private bool GetDailyTPSeries(OnResponse response, string endpoint, string exch, string token, string starttime, string endtime)
        {           
            return true;
        }

        private bool SendGetOptionChain(OnResponse response, string exch, string tsym, string strprc, int count)
        {
            if (loginResp == null)
                return false;
